...
const chartOptions = ref({
	...
	plotOptions: {
		bar: {
			borderRadius: 2,
			distributed:
				props.chart_config?.plotOptions?.bar?.distributed === undefined
					? true
					: props.chart_config.plotOptions.bar.distributed,
			horizontal: true,
		},
	},
	stroke: {
		colors: ["#282a2c"],
		show: true,
		width: props.chart_config.stroke?.width
			? props.chart_config.stroke.width
			: 0,
	},
